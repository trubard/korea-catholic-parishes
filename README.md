...
**수집 교구 (15개 교구):** 서울대·인천·수원·의정부·춘천·원주·대전·청주·대구대·부산·마산·전주·광주대·군종·제주.
교구마다 홈페이지 구조가 달라 교구별 어댑터(`scraper/mass/dioceses/`)로 수집합니다.

> - **안동교구**는 홈페이지에 미사시간이 공란이라 제외했습니다.
> - **마산교구**는 통합 본당 목록이 없고 본당별 독립 사이트를 써서, 확인된 본당만
>   `dioceses/masan.py`의 맵으로 개별 수집합니다(미사시간을 이미지로 올린 본당은 제외).
